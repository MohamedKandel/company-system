...
import company.project.Tools.Table;
import java.sql.*;
...
public class database {
    ...
    public static void FillCombo(String TblName,String ColName,JComboBox comb){
        try{
            setConnection();
            st = con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            
            String select = "select " + ColName + " from "+ TblName;
    ...
    public static void fillToJTable(String tblNameOrQuery,JTable tbl){
        try{
            ...
            if ("select ".equals(SPart)) {
                ...
                select = "select * from " + tblNameOrQuery;
            }
            rs = st.executeQuery(select);
